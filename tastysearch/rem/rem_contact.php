...
<h2>Send Feedbacks</h2>
  <div id="feedbackform">
   ...
   <form action="rem_contact.php" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-sm-2">
...
if (isset($_POST['submit'])) 
{
  ...
  $sql = "insert into r_feedback (fname, lname, feedback) values ('$fname','$lname','$feedback')";
...
// Perform queries 
mysqli_query($con,"SELECT * FROM r_feedback");
mysqli_query($con,"INSERT INTO r_feedback (fname, lname, feedback) values ('$fname','$lname','$feedback')");
