  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="cinnabon_order.php" ><span class="glyphicon glyphicon-shopping-cart"></span> YOUR ORDER</a></li>
      </ul> 
    </div>
  </div>
</nav>
...
<h2>Send Feedbacks</h2>
  <div id="feedbackform">
   ...
   <form action="cinnabon_contact.php" method="post" enctype="multipart/form-data">
      <div class="row">
        <div class="col-sm-2">
...
if (isset($_POST['submit'])) 
{
  ...
  $sql = "insert into c_feedback (fname, lname, feedback) values ('$fname','$lname','$feedback')";
...
// Perform queries 
mysqli_query($con,"SELECT * FROM c_feedback");
mysqli_query($con,"INSERT INTO c_feedback (fname, lname, feedback) values ('$fname','$lname','$feedback')");
